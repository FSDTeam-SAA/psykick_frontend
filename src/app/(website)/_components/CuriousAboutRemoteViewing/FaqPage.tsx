...
{/* FAQ items  */}
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          <AccordionItem value="item-5" className="border-b-[#4C2A85]">
            ...
            <AccordionContent className="text-[#C5C5C5] text-[16px] font-normal">
            Consistent practice is key. Our platform provides feedback and scoring for every session, allowing you to measure your success rate over time. The more you practice, the better you will become at distinguishing accurate impressions from analytical interference.            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-5" className="border-b-[#4C2A85]">
            <AccordionTrigger className="text-left hover:no-underline challange-subTitle">
            7. Can I see how other users are performing?            </AccordionTrigger>
            <AccordionContent className="text-[#C5C5C5] text-[16px] font-normal">
            Yes! We have leaderboards where you can compare your performance against other remote viewers. You can also track your own progress and see how your accuracy improves over multiple sessions.           </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-5" className="border-b-[#4C2A85]">
            <AccordionTrigger className="text-left hover:no-underline challange-subTitle">
            8. How often should I practice Remote Viewing?          </AccordionTrigger>
            <AccordionContent className="text-[#C5C5C5] text-[16px] font-normal">
            This depends on your personal goals. Some people practice daily, while others do weekly sessions. The more frequently you practice, the more you will refine your skills. Our challenges are designed to provide regular opportunities for you to test yourself and improve.           </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-5" className="border-b-[#4C2A85]">
            <AccordionTrigger className="text-left hover:no-underline challange-subTitle">
            ...
            <AccordionContent className="text-[#C5C5C5] text-[16px] font-normal">
            Some practitioners use RV for predictive purposes, such as Associative Remote Viewing (ARV), which links targets to future events. While RV has been tested for predictive accuracy, results vary between individuals. Our ARV challenges allow you to experiment with this method and see how well it works for you.           </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-5" className="border-b-[#4C2A85]">
            <AccordionTrigger className="text-left hover:no-underline challange-subTitle">
            ...
            <AccordionContent className="text-[#C5C5C5] text-[16px] font-normal">
            Simply sign up and participate in our active TMC and ARV sessions. Every challenge is an opportunity to test your abilities, improve your accuracy, and climb the leaderboard. Get started today and see where your intuition takes you!          </AccordionContent>
          </AccordionItem>
