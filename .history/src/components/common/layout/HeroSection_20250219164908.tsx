      ...
      <div className="container">
        <div className="flex justify-between items-end">
          <div>
            ...
            <article className="w-[400px] paragraph !font-inter p-5 bg-[#F8F8F8]/10 backdrop-blur-lg rounded-2xl border-2 border-[#7c4bb8]">
          ...
          <article className="w-[400px] paragraph !font-inter p-8 bg-[#F8F8F8]/10 backdrop-blur-lg rounded-2xl border-2 border-[#7c4bb8]">
