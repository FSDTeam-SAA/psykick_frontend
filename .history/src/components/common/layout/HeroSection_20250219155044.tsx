  ...
  return (
    ...
    >
      <div className="container">
        <div className=" __className_559008">
          <h1 className="title pt-20">Discover the unseen...</h1>
          <article className="w-[400px] pt-[24px] p-5 bg-white/10 backdrop-blur-lg">
        ...
        <article className="w-[400px] paragraph !font-inter p-8 bg-white/10 backdrop-blur-lg">
