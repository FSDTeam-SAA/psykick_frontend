    ...
    >
      <div className="container">
        <div className="flex justify-between items-end">
          ...
          <article className="w-[400px] paragraph !font-inter p-8 bg-[#F8F8F8]/10 backdrop-blur-lg rounded-2xl border border-[#562199]">
            &apos;The intuitive mind is a sacred gift and the rational mind is a
            faithful servant. We have created a society that honors the servant
            and has forgotten the gift. &apos; <br /> — Carl Jung
          </article>

          {/* <ShineBorder className=" w-[300px]">
            <article>
              <p className=" text-black bg-white/10 backdrop-blur-lg rounded-2xl t">
