      ...
      <div className="container">
        <div className="flex justify-between items-end">
          <div>
            ...
            <article className="w-[400px] pt-[24px] p-5 bg-[#F8F8F8]/10 backdrop-blur-lg paragraph rounded-2xl gradient-border">
          ...
          <article className="w-[400px] paragraph !font-inter p-8 bg-[#F8F8F8]/10 backdrop-blur-lg rounded-2xl gradient-border">
