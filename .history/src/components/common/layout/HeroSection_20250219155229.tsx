      ...
      <div className="container">
        <div className="flex justify-between items-end">
          <div>
            ...
            <article className="w-[400px] pt-[24px] p-5 bg-white/10 backdrop-blur-lg paragraph rounde">
          ...
          <article className="w-[400px] paragraph !font-inter p-8 bg-white/10 backdrop-blur-lg rounde">
